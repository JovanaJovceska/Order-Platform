...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2022 at 11:42 PM
...
(1, 'Kumanovo', 'Sandra', 'Petrusevska', 'petrusevskasandra9@gmail.com', '21232f297a57a5a743894a0e4a801fc3', '070111000', 1),
(2, 'Skopje', 'Bisera', 'Runceva', 'biserarunceva@gmail.com', '21232f297a57a5a743894a0e4a801fc3', '078888222', 2),
(5, 'Skopje', 'Jovana', 'Jovceska', 'jovceska.jovana@gmail.com', '21232f297a57a5a743894a0e4a801fc3', '079999999', 0),
(50, 'Skopje', 'Jovana', 'Jovceska', 'webappfeit@gmail.com', 'b6920d9083c8e76685bcc8db34b8c9bb', '12345678', 5);
...
--
ALTER TABLE `korisnik`
  MODIFY `KorisnikID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
...
--
ALTER TABLE `proizvod`
  MODIFY `ProizvodID` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;
